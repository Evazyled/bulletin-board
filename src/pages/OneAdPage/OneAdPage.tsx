...
const OneAdPage = () => (
  <div className={`${style.oneAdPage} ${style.container}`}>
    <Link to="/">
      <svg
        width="24"
        height="24"
    ...
    <div className={style.oneAdPage__header}>
      <div className={style.oneAdPage__header__left}>
        <span className={style.datePublication}>14 апреля 2022</span>
        <div className={style.adName}>Стиральная машина Bosch</div>
        <div className={style.model}>WS-25645-253-55</div>
      ...
      <div className={style.oneAdPage__header__right}>
